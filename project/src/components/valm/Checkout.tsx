...
export default function Checkout({ items, onClose, onSuccess, customerSession }: CheckoutProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-[#2B2823]/80 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-[#2B2823] border border-white/10 rounded-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto shadow-2xl">

        <div className="sticky top-0 bg-[#2B2823] border-b border-white/10 px-6 py-4 flex items-center justify-between rounded-t-2xl z-10">
          ...
          {step === 'shipping' && (
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full bg-white hover:bg-gray-100 disabled:bg-white/10 disabled:text-gray-600 text-[#2B2823] font-semibold py-3 rounded-xl transition-all duration-200"
              >
                Continuar al Pago
              </button>
            </div>
          ...
          {step === 'payment' && (
            <div className="space-y-4">
              ...
              <button
                onClick={placeOrder}
                disabled={loading}
                className="w-full bg-white hover:bg-gray-100 disabled:bg-white/20 disabled:text-gray-600 text-[#2B2823] font-semibold py-4 rounded-xl transition-all flex items-center justify-center gap-2"
              >
                {loading ? (
          ...
          {step === 'confirm' && (
            <div className="text-center space-y-6 py-6">
              ...
              <button
                ...
                className="w-full bg-white hover:bg-gray-100 text-[#2B2823] font-semibold py-3 rounded-xl transition-colors"
              >
                Continuar comprando
              </button>
            </div>
