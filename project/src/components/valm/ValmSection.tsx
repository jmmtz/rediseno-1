      ...
      <div className="relative overflow-hidden bg-[#1a1a1a]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          ...
          <a
            ...
            className="inline-flex items-center gap-2.5 bg-white text-[#2B2823] font-semibold text-sm px-7 py-3.5 rounded-full hover:bg-[#f5e6e6] transition-colors duration-200 group"
          >
        ...
        <div className="mt-14 text-center">
          <div className="inline-flex flex-col sm:flex-row items-center gap-4 bg-[#1a1a1a] rounded-2xl px-8 py-7">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="shrink-0 inline-flex items-center gap-2 bg-white text-[#2B2823] font-semibold text-sm px-6 py-3 rounded-full hover:bg-[#f5e6e6] transition-colors duration-200 group whitespace-nowrap"
            >
              Comprar en VALM Cosmetics
