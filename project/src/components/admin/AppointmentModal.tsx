...
export default function AppointmentModal({ appointment, staff, onClose, onRefresh }: AppointmentModalProps) {
  ...
  const inputCls = "bg-[#FBFBF9] border border-gray-200 rounded-xl px-4 py-3 text-gray-900 placeholder-gray-400 focus:border-[#2B2823] focus:ring-2 focus:ring-[#2B2823]/20 focus:outline-none text-sm transition-all";
        ...
        <div className="px-6 py-5 space-y-5">
          ...
          <div className="bg-[#FBFBF9] border border-gray-100 rounded-xl p-4 space-y-2">
            ...
            {appointment.payment_amount > 0 && (
              <p className="text-[#8A7A5C] font-semibold text-sm">Anticipo pagado: ${appointment.payment_amount.toLocaleString()} MXN</p>
            )}
          </div>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="bg-[#2B2823] hover:bg-[#3A362F] text-white text-xs font-semibold px-4 py-2 rounded-2xl transition-colors flex items-center gap-1.5"
                  >
                    <UserCheck size={14} />
                    Asignar
                  </button>
              ...
              {!cancelSilent && (
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full bg-[#FBFBF9] border border-gray-200 rounded-xl px-4 py-3 text-gray-900 placeholder-gray-400 focus:border-[#2B2823] focus:ring-2 focus:ring-[#2B2823]/20 focus:outline-none text-sm resize-none transition-all"
                  />
                </div>
              )}
