...
export default function AdminDashboard({ onLogout }: AdminDashboardProps) {
  ...
  const inputCls = "bg-[#FBFBF9] border border-gray-200 rounded-xl px-3 py-2 text-gray-900 placeholder-gray-400 focus:border-[#2B2823] focus:ring-2 focus:ring-[#2B2823]/20 focus:outline-none text-sm transition-all";
    ...
    <div className="min-h-screen bg-[#FBFBF9] flex">
      ...
      <aside className="hidden lg:flex flex-col w-60 border-r border-gray-100 bg-[#FBFBF9] shrink-0 shadow-sm">
        <div className="p-5 border-b border-gray-100">
          <img src="/IMG_4562.PNG" alt="La Rue" className="h-9 w-auto object-contain" />
          ...
          {navItems.map((item) => (
            <button
              ...
              className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-all duration-200 ${
                tab === item.key
                  ? 'bg-[#2B2823] text-white font-semibold shadow-sm'
        ...
        <div className="p-3 border-t border-gray-100 space-y-1">
          <button
            onClick={onLogout}
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-[#8A7A5C] hover:text-[#2B2823] hover:bg-[#F0E8DA] border border-[#2B2823]/40 font-medium transition-colors"
          >
            <Home size={18} />
            Salir al Inicio
          </button>
        ...
        {navItems.map((item) => (
          <button
            ...
            className={`flex flex-col items-center gap-1 px-3 py-2 rounded-lg text-xs transition-colors whitespace-nowrap shrink-0 ${
              tab === item.key ? 'text-[#8A7A5C]' : 'text-gray-400'
            }`}
          >
            {item.icon}
          ...
          <div className="flex items-center gap-3">
            <div className="hidden md:flex items-center gap-2">
              ...
              <select
                ...
                className="bg-[#FBFBF9] border border-gray-200 rounded-lg px-3 py-1.5 text-gray-700 text-xs focus:border-[#2B2823] focus:outline-none"
              >
            ...
            <div className="space-y-5">
              <div className="flex items-center gap-4">
                <input
                  ...
                  className="bg-[#FBFBF9] border border-gray-200 rounded-lg px-4 py-2 text-gray-900 text-sm focus:border-[#2B2823] focus:outline-none"
                />
                    ...
                    <tbody className="divide-y divide-gray-50">
                      {todayAppts.sort((a, b) => a.appointment_time.localeCompare(b.appointment_time)).map((appt) => (
                        <tr key={appt.id} className="hover:bg-[#FBFBF9] transition-colors cursor-pointer" onClick={() => setSelectedAppt(appt)}>
                          <td className="px-4 py-3 text-[#8A7A5C] font-bold">{appt.appointment_time.slice(0,5)}</td>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="bg-[#FBFBF9] rounded-2xl border border-gray-100 p-5 shadow-sm">
                  ...
                  <p className="text-[#8A7A5C] text-4xl font-black">${ingresosEstimados.toLocaleString('es-MX')}</p>
          ...
          {tab === 'staff' && (
            <div className="space-y-6">
              ...
              <div className="bg-[#FBFBF9] border border-gray-100 rounded-xl p-5 space-y-3 shadow-sm">
                      ...
                      return (
                        <button
                          ...
                          className={`text-xs px-3 py-1.5 rounded-full border transition-colors ${
                            selected ? 'bg-[#2B2823] border-[#2B2823] text-white font-semibold' : 'border-gray-200 text-gray-500 hover:border-gray-400'
                          }`}
                        >
                          {svc.name}
                        </button>
                ...
                <button onClick={addStaff} className="bg-[#2B2823] hover:bg-[#3A362F] text-white text-sm font-semibold px-5 py-2 rounded-2xl transition-colors flex items-center gap-2">
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="relative shrink-0">
                          {s.avatar_url ? (
                            ...
                            <div className="w-12 h-12 rounded-full bg-[#F0E8DA] flex items-center justify-center text-[#8A7A5C] font-bold">
                              {s.name.charAt(0)}
                            </div>
                          )}
                          <button
                        ...
                        {isEditing ? (
                          <div className="flex-1 space-y-2">
                                ...
                                {services.map((svc) => {
                                  ...
                                  return (
                                    <button
                                      ...
                                      className={`text-xs px-2.5 py-1 rounded-full border transition-colors ${sel ? 'bg-[#2B2823] border-[#2B2823] text-white font-semibold' : 'border-gray-200 text-gray-400 hover:border-gray-400'}`}
                                    >
                                      {svc.name}
                                    </button>
                                  );
                            ...
                            <div className="flex gap-2">
                              <button onClick={() => saveStaff(s.id)} className="bg-[#2B2823] hover:bg-[#3A362F] text-white text-xs font-semibold px-4 py-1.5 rounded-2xl flex items-center gap-1.5"><Save size={13} /> Guardar</button>
                        ...
                        {!isEditing && (
                          <div className="flex items-center gap-2 shrink-0">
                            <button
                              ...
                              className="text-gray-400 hover:text-[#8A7A5C] transition-colors p-1.5 rounded-lg hover:bg-[#F0E8DA]"
                            >
                              <Edit2 size={15} />
                            </button>
                            <button
          ...
          {tab === 'services' && (
            <div className="space-y-6">
              <div className="bg-[#FBFBF9] border border-gray-100 rounded-xl p-5 space-y-3 shadow-sm">
                ...
                <button onClick={addService} className="bg-[#2B2823] hover:bg-[#3A362F] text-white text-sm font-semibold px-5 py-2 rounded-2xl transition-colors flex items-center gap-2">
                  <Plus size={16} /> Agregar
                </button>
              </div>
                    ...
                    <div key={s.id} className="bg-[#FBFBF9] border border-gray-100 rounded-xl p-4 shadow-sm">
                      {isEditing ? (
                        <div className="space-y-2">
                          ...
                          <div className="flex gap-2">
                            <button onClick={() => saveService(s.id)} className="bg-[#2B2823] hover:bg-[#3A362F] text-white text-xs font-semibold px-4 py-1.5 rounded-2xl flex items-center gap-1.5"><Save size={13} /> Guardar</button>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <button onClick={() => { setEditingServiceId(s.id); setEditServiceData({ name: s.name, price_min: s.price_min, price_max: s.price_max, duration_minutes: s.duration_minutes }); }} className="text-gray-400 hover:text-[#8A7A5C] p-1.5 rounded-lg hover:bg-[#F0E8DA] transition-colors"><Edit2 size={15} /></button>
          ...
          {tab === 'coupons' && (
            <div className="space-y-6">
              <div className="bg-[#FBFBF9] border border-gray-100 rounded-xl p-5 space-y-3 shadow-sm">
                ...
                <button onClick={addCoupon} className="bg-[#2B2823] hover:bg-[#3A362F] text-white text-sm font-semibold px-5 py-2 rounded-2xl transition-colors flex items-center gap-2">
                    ...
                    <div key={c.id} className={`bg-[#FBFBF9] border rounded-xl p-4 shadow-sm ${c.is_active ? 'border-gray-100' : 'border-gray-100 opacity-50'}`}>
                      {isEditing ? (
                        <div className="space-y-2">
                          ...
                          <div className="flex gap-2">
                            <button onClick={() => saveCoupon(c.id)} className="bg-[#2B2823] text-white text-xs font-semibold px-4 py-1.5 rounded-2xl flex items-center gap-1.5"><Save size={13} /> Guardar</button>
                        ...
                        <div className="flex items-center gap-3">
                          <div className="flex-1">
                            <div className="flex items-center gap-2">
                              <p className="text-[#8A7A5C] font-mono font-bold text-sm">{c.code}</p>
                          ...
                          <button onClick={() => { setEditingCouponId(c.id); setEditCouponData({ code: c.code, discount_type: c.discount_type, discount_value: c.discount_value }); }} className="text-gray-400 hover:text-[#8A7A5C] p-1.5 rounded-lg hover:bg-[#F0E8DA] transition-colors"><Edit2 size={15} /></button>
          ...
          {tab === 'promos' && (
            <div className="space-y-6">
              <div className="bg-[#FBFBF9] border border-gray-100 rounded-xl p-5 space-y-3 shadow-sm">
                ...
                <button onClick={addPromo} className="bg-[#2B2823] hover:bg-[#3A362F] text-white text-sm font-semibold px-5 py-2 rounded-2xl transition-colors flex items-center gap-2">
                    ...
                    <div key={p.id} className="bg-[#FBFBF9] border border-gray-100 rounded-xl p-4 shadow-sm">
                      {isEditing ? (
                        <div className="space-y-2">
                          ...
                          <div className="flex gap-2">
                            <button onClick={() => savePromo(p.id)} className="bg-[#2B2823] text-white text-xs font-semibold px-4 py-1.5 rounded-2xl flex items-center gap-1.5"><Save size={13} /> Guardar</button>
                          ...
                          <div className="flex-1">
                            ...
                            {p.original_price > 0 && (
                              <p className="text-xs mt-0.5">
                                ...
                                <span className="text-[#8A7A5C] font-semibold ml-1">${p.promo_price.toLocaleString()} MXN</span>
                              </p>
                            )}
                          </div>
                          <button onClick={() => { setEditingPromoId(p.id); setEditPromoData({ title: p.title, discount_value: p.discount_value, promo_price: p.promo_price }); }} className="text-gray-400 hover:text-[#8A7A5C] p-1.5 rounded-lg hover:bg-[#F0E8DA] transition-colors"><Edit2 size={15} /></button>
                ...
                <div className="space-y-2 font-mono text-xs">
                  {['TWILIO_ACCOUNT_SID', 'TWILIO_AUTH_TOKEN', 'TWILIO_WHATSAPP_FROM'].map((v) => (
                    <div key={v} className="bg-[#FBFBF9] border border-gray-100 rounded px-3 py-2 text-gray-500 flex items-center gap-2">
                      <Clock size={12} className="text-[#8A7A5C]" />
